    ...
    <span class='form_title'>Draft Configuration</span>
    <br><br>
    <?php
    //open form
    ...
    echo '<br><br>';
    //scoring type
    $scoring = array('Standard'=>'Standard', 'PPR'=>'PPR');
    echo form_label('Scoring: ', 'form_scoring');
    echo form_dropdown('scoring', $scoring, array('standard'=>'standard'), array('id'=>'form_scoring'));
    echo '<br><br>';
    //draft type
    $draft = array('Auto'=>'Auto', 'Simulation'=>'Simulation', 'Live Mock'=>'Live Mock');
